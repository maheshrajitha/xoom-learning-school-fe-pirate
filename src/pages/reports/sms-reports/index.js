...
import CustomerEaxamReportTable from "./SmsReportTable";
      ...
      <Container fluid className="p-0">
        <div>
          <Breadcrumb>
            ...
            <BreadcrumbItem active>SMS Report</BreadcrumbItem>
          </Breadcrumb>
        </div>
        <h1 className="h3 mb-3">SMS Report</h1>

        <Card>
          <CardHeader>
            <CardTitle tag="h5">SMS Report filter(s)</CardTitle>
            <hr />
          </CardHeader>
          <CardBody>

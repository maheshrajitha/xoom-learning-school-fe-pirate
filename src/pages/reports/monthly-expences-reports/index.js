...
import EmployeeSalaryReportTable from "./MonthlyExpencesTable";
      ...
      <Container fluid className="p-0">
        <div>
          <Breadcrumb>
            ...
            <BreadcrumbItem active>Monthly Expences Report</BreadcrumbItem>
          </Breadcrumb>
        </div>
        <h1 className="h3 mb-3">Monthly Expences Report</h1>

        <Card>
          <CardHeader>
            <CardTitle tag="h5">Monthly Expences Report Filter(s)</CardTitle>
            <hr />
          </CardHeader>
          <CardBody>

...
import EmployeeSalaryReportTable from "./EmployeeSalaryReportTable";
      ...
      <Container fluid className="p-0">
        <div>
          <Breadcrumb>
            ...
            <BreadcrumbItem active>Employee Salary Report</BreadcrumbItem>
          </Breadcrumb>
        </div>
        <h1 className="h3 mb-3">Employee Salary Report</h1>

        <Card>
          <CardHeader>
            <CardTitle tag="h5">Employee Salary Report filter(s)</CardTitle>
            <hr />
          </CardHeader>
          <CardBody>

...
import CustomerEaxamReportTable from "./CustomerEaxamReportTable";
      ...
      <Container fluid className="p-0">
        <div>
          <Breadcrumb>
            ...
            <BreadcrumbItem active>Customer Exam Report</BreadcrumbItem>
          </Breadcrumb>
        </div>
        <h1 className="h3 mb-3">Customer Exam Report</h1>

        <Card>
          <CardHeader>
            <CardTitle tag="h5">Customer Exam Report filter(s)</CardTitle>
            <hr />
          </CardHeader>
          <CardBody>

...
import CustomerEaxamReportTable from "./StaffAttendanceTable";
      ...
      <Container fluid className="p-0">
        <div>
          <Breadcrumb>
            ...
            <BreadcrumbItem active>Staff Attendance</BreadcrumbItem>
          </Breadcrumb>
        </div>
        <h1 className="h3 mb-3">Staff Attendance</h1>

        <Card>
          <CardHeader>
            <CardTitle tag="h5">filter(s)</CardTitle>
            <hr />
          </CardHeader>
          <CardBody>

...
import CustomerEaxamReportTable from "./CustomerTrialReportTable";
      ...
      <Container fluid className="p-0">
        <div>
          <Breadcrumb>
            ...
            <BreadcrumbItem active>Customer Trail Report</BreadcrumbItem>
          </Breadcrumb>
        </div>
        <h1 className="h3 mb-3">Customer Trail Report</h1>

        <Card>
          <CardHeader>
            <CardTitle tag="h5">Customer Trail Report filter(s)</CardTitle>
            <hr />
          </CardHeader>
          <CardBody>

...
import EmployeeSalaryReportTable from "./ReportInactiveCustomersTable";
      ...
      <Container fluid className="p-0">
        <div>
          <Breadcrumb>
            ...
            <BreadcrumbItem active>Report Inactive Customers</BreadcrumbItem>
          </Breadcrumb>
        </div>
        <h1 className="h3 mb-3">Report Inactive Customers</h1>

        <Card>
          <CardHeader>
            <CardTitle tag="h5">Report Inactive Customers filter(s)</CardTitle>
            <hr />
          </CardHeader>
          <CardBody>

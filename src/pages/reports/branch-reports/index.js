...
import BranchReportTable from "./BranchReportTable";
      ...
      <Container fluid className="p-0">
        <div>
          <Breadcrumb>
            ...
            <BreadcrumbItem active>Brnach Report</BreadcrumbItem>
          </Breadcrumb>
        </div>
        <h1 className="h3 mb-3">Brnach Report</h1>

        <Card>
          <CardHeader>
            <CardTitle tag="h5">Brnach Report filter(s)</CardTitle>
            <hr />
          </CardHeader>
          <CardBody>
